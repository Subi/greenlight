...
func (app *application) writeJSON(w http.ResponseWriter, status int, v interface{}, headers http.Header) error {
...
func (app *application) readJSON(r *http.Request, w http.ResponseWriter, v interface{}) error {
